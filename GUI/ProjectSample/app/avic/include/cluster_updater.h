...
public:
    ...
    inline void setGearPindle(const unsigned char &_p) {ValueSource->setProperty("pindle_int",QVariant(_p));}
    inline void setText(const QString &_p) {ValueSource->setProperty("txt",QVariant(_p));}
